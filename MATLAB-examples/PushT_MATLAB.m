...
% Initial states
th_init = pi/3; params.th_init = th_init;
sx_init = 0.2; params.sx_init = sx_init;
sy_init = 0.1; params.sy_init = sy_init;
% vertices of the box 
...
fprintf(fid, 'PushT  N=%d, Relax=%s, TS=%s, CS=%s, result=%.20f, operation time=%.5f, mosek time=%.5f,', N, relax_mode, ts_mode, cs_mode, result, aux_info.time, aux_info.mosek_time);
fclose(fid);
