function aux_info = PushBot_test(relax_mode, cs_mode, ts_mode, init_status)
...
% init states
a_init = init_status(1); params.a_init = a_init;
v_init = init_status(2); params.v_init = v_init;
th_init = init_status(3); params.th_init = th_init;
dth_init = init_status(4); params.dth_init = dth_init;
% final states
